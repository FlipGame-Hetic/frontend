...
export const MULTIBALL_GATE_OPEN_DISTANCE = 0.42
export const MULTIBALL_GATE_TRIGGER_MIN_Z_VELOCITY = 0
export const MULTIBALL_GATE_HALF_EXTENTS: Vector3Tuple = [0.2, 0.2, 0.2]
export const MULTIBALL_GATE_POSITION: Vector3Tuple = [0, 2, 0]
