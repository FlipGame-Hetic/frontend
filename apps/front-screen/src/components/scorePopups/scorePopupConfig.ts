...
export const MULTIBALL_TRIGGER_POPUP_DURATION = 0.95
export const MULTIBALL_TRIGGER_POPUP_FADE_OUT_START = 0.55
export const MULTIBALL_TRIGGER_POPUP_SCALE_START = 0.7
export const MULTIBALL_TRIGGER_POPUP_SCALE_HIT_PROGRESS = 0.14
export const MULTIBALL_TRIGGER_POPUP_SCALE_HIT = 1.2
export const MULTIBALL_TRIGGER_POPUP_SCALE_END = 1.5

const SCORE_POPUP_NEGATIVE_COLOR = "#FF3333"
const SCORE_POPUP_COLOR_MAX_AMOUNT = 500
const SCORE_POPUP_MIN_COLOR_OPACITY = 0.34

export const SCORE_POPUP_GLITCH_THRESHOLD = 500
export const SCORE_POPUP_GLITCH_DURATION = 0.55
export const SCORE_POPUP_GLITCH_HOLD = 0.18
export const SCORE_POPUP_GLITCH_SPLIT = 0.075
export const SCORE_POPUP_GLITCH_JITTER = 0.032
export const SCORE_POPUP_GLITCH_STEP_RATE = 52
