...
export const PLUNGER_BALL_SPAWN: PositionType = [4.5, 0.5, 7]
...
export const PLUNGER_MIN_IMPULSE = 15
export const PLUNGER_MAX_IMPULSE = 42

export const PLUNGER_LANE_FRICTION = 0.05

export const PLUNGER_RELEASE_SPEED = 25

export const PLUNGER_CHARGE_FACTOR = 2
