export const SLINGSHOT_RESTITUTION = 1.5
export const SLINGSHOT_IMPULSE_STRENGTH = 2
...
export const SLINGSHOT_RUBBER_BLOOM_COLOR = "#00eaff"
export const SLINGSHOT_RUBBER_BLOOM_INTENSITY = 2.4
